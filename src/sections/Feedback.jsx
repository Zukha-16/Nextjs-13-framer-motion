      ...
      >
        ...
        >
          ...
          <div className="">
            ...
            <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[60px] text-white">
              Founder | Metaversus
            </p>
          </div>
          <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
            "With the development of today's technology, metaverses is very
            useful for today's work, or can be called web 3.0. by using
            metaverse you can use it as anythin"
          </p>
        </motion.div>
        <motion.div
